...
class _$Initial<T> with DiagnosticableTreeMixin implements Initial<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'ViewState<$T>.initial'));
  }
...
class _$Loading<T> with DiagnosticableTreeMixin implements Loading<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ViewState<$T>.loading'));
  }
...
class __$$DataCopyWithImpl<T, $Res>
    extends _$ViewStateCopyWithImpl<T, $Res, _$Data<T>>
...
class _$Data<T> with DiagnosticableTreeMixin implements Data<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ViewState<$T>.data'))
...
class _$Error<T> with DiagnosticableTreeMixin implements Error<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ViewState<$T>.error'))
